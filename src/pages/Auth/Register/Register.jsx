...
const handleRegistration = (data) => {
            ...
            axios.post(`https://api.imgbb.com/1/upload?key=${import.meta.env.VITE_image_host_key}`, formData)
                .then(res => {
                    ...
                    axiosSecure.post('/users', userInfo)  
                        ...
                        .catch(err => console.log("DB Error:", err.response?.data));
    ...
    return (
          <div className="card bg-base-100 w-full mx-auto max-w-sm shrink-0 shadow-2xl">
            <h3 className="text-2xl text-center">Welcome to CivicHelp Desk</h3>
            ...
            <form className="card-body" onSubmit={handleSubmit(handleRegistration)}>
                <fieldset className="fieldset">
                 ...
                 <p>Already have an account  <Link className='text-blue-500 underline'
